...
describe('Titanium.UI.TabGroup', () => {
	...
	afterEach(function (done) {
		...
		// FIXME: Android fires the close event twice so we need an extra check here
		let closed = false;
	...
	describe('events', function () {
		...
		// FIXME Event fires twice on android
		it.androidBroken('close', finish => {
			const win = Ti.UI.createWindow();
			tabGroup = Ti.UI.createTabGroup();
			const tab = Ti.UI.createTab({
				title: 'Tab',
	...
	it('title after drawing the TabGroup', done => {
		const winA = Ti.UI.createWindow(),
			winB = Ti.UI.createWindow(),
